 ...
 * modelid	smallint(5) unsigned	YES		0	</br>
 * catid	smallint(5) unsigned	YES		0	</br>
 * name	char(30)	NO			</br>
 * maxnum	smallint(5) unsigned	NO		20</br>	
 * listorder	smallint(5) unsigned	NO		0	</br>
 * thumb	varchar(150)	NO			</br>
 * 
 * @author Yinchuan Dai 戴银川 (daiyinchuan@163.com)
 *
 */
public class Position extends BaseModel<Position>{
	private static final long serialVersionUID=-3362130252766529105L;
