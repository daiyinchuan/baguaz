...
public class AutoBindRoutes extends Routes {
	...
	protected static final Logger log = Logger.getLogger(AutoBindRoutes.class);
    ...
    public AutoBindRoutes scanPackages(List<String> scanPaths) {
        if (scanPaths != null) {
    ...
    public void config() {
        List<Class<? extends Controller>> controllerClasses = ClassSearcher.of(Controller.class)
                ...
                .scanPackages(scanPackages).search();
