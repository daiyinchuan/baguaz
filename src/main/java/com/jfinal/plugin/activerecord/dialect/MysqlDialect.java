...
public class MysqlDialect extends Dialect {
	...
	public void select(StringBuilder sql,String columns,String tableName,String where,String order,String group,String limit){
		where = where.equals("") ? "" : " WHERE "+where;
		order = order.equals("") ? "" : " ORDER BY "+order;
		group = group.equals("") ? "" : " GROUP BY "+group;
		limit = limit.equals("") ? "" : " LIMIT "+limit;
		sql.append("SELECT ").append(columns).append(" FROM ").append(tableName)
		   .append(where).append(group).append(order).append(limit);
	}
	
	public void getOne(StringBuilder sql,String columns,String tableName,String where,String order,String group){
		where = where.equals("") ? "" : " WHERE "+where;
		order = order.equals("") ? "" : " ORDER BY "+order;
		group = group.equals("") ? "" : " GROUP BY "+group;
