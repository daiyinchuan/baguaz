        ...
        $.each(attr, function(key, value) {
          switch (key) {
            ...
            case 'id':
              ...
              $entity.find('.' + _this.classes.branchName + ' > input').attr("value", value);
              $entity.find('.' + _this.classes.itemName + ' > input').attr("value", value);
              break;

            case 'href':
              $entity.find('a.am-tree-label').attr(key,value);
              break;
